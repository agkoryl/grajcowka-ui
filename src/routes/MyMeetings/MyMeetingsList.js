...
class MyMeetingsList extends Component {
                            ...
                            <Grid container item xs={12} lg={9} justify="center" >
                                {userMeetings.map(meeting =>
                                    this.checkIfIsHost(meeting) && <MyMeetingTile
                                        ...
                                        openMeetingSnackbar={this.props.openMeetingSnackbar}
                                    />
                                )}
                            </Grid>
                        </TabPanel>
                        ...
                        <Grid container item xs={12} lg={9} >
                                {userMeetings.map(meeting =>
                                    !this.checkIfIsHost(meeting) && <MyMeetingTile
                                        ...
                                        isPlayer={!this.checkIfIsHost(meeting)}
                                        handleReload={this.handleReload}
                                        openPlayerSnackbar={this.props.openPlayerSnackbar}
                                    />
                                )}
                            </Grid>
                         </TabPanel>
...
export default withStyles(styles)(MyMeetingsList);
